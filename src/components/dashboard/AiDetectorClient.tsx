...
import { Loader2, ScanText, ArrowRight, FileUp, Sparkles, CheckCircle } from 'lucide-react';
    ...
    <div className="space-y-8">
      <Card className="shadow-lg">
        <form action={formAction}>
          <CardHeader>
            <CardTitle className="text-2xl font-bold">AI Content Detector & Improver</CardTitle>
            <CardDescription>
