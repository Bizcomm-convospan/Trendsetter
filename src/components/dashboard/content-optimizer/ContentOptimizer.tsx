...
import { Loader2, Sparkles, CheckCircle, FileText, BarChart, BookOpen, Lightbulb, Languages, Edit, Type, Palette, Bold, Italic, Underline, List, Heading2, Heading3, Save, ArrowLeft, Heading1 } from 'lucide-react';
